...
class Collegamenti {
    ...
    private function setValues(): void {
        ...
        $this->collegamenti = [
            ...
            'controllo_documento'   => $this->base . "/v1/students/" . $this->ident . "/documents/check/"  . $this->document_id,
            'leggi_documento'       => $this->base . "/v1/students/" . $this->ident . "/documents/read/"   . $this->document_id,
            ...
            'leggi_nota'            => $this->base . "/v1/students/" . $this->ident . "/notes/"        . $this->noteType  . "/read/" . $this->elementId,
